...
class singlePlayer(Screen):
    ...
    def noRenderActivate(self):
        noRenderActivate(True, False, False, False)
...
main_window.add_widget(introVideo(name = "Intro_Video"))

# Activate Screen
main_window.add_widget(activate(name = "Activate"))
...
def manualCon(mode):
    if (mode == 0):
        ...
        commandStr = 'cmd /c "activate CarlaCompat && python WASDManualControl1.py --filter=walker'
        os.system(commandStr)
